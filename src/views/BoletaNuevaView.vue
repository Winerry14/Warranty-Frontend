...
const rutaArchivoServidor = ref("")   // NUEVO: ruta devuelta por el backend
...
const guardar = async () => {
  try {
    ...
    const payload = {
      ...
      urlImagen: rutaArchivoServidor.value || null,   // ahora sí guardamos la ruta
    ...
    await axios.post(`${API_BASE}/boletas`, payload)
